...
import com.cerp.Modelo.Preguntas;
import com.cerp.Vista.InicioVista;

/**
 * @file com.cerp.Main.java
 * @brief Clase principal del programa que permite crear, modificar y eliminar
 * preguntas.
 * @date 20/03/2023
 * @version 1.0
...
/**
 * @class com.cerp.Main
 * @brief Clase principal que permite interactuar con la aplicación de
 * preguntas.
